...
struct UINode {
    ...
    std::uint32_t min_width_unit = UI_SIZE_UNIT_AUTO;
    bool has_max_width = false;
    float max_width = 0.0f;
    std::uint32_t max_width_unit = UI_SIZE_UNIT_AUTO;
    bool has_min_height = false;
    float min_height = 0.0f;
    std::uint32_t min_height_unit = UI_SIZE_UNIT_AUTO;
    bool has_max_height = false;
    float max_height = 0.0f;
    std::uint32_t max_height_unit = UI_SIZE_UNIT_AUTO;
    bool has_flex_basis = false;
    float flex_basis = 0.0f;
    bool has_align_self = false;
    std::uint32_t align_self = UI_ALIGN_SELF_AUTO;
    bool fill_width = false;
    bool fill_height = false;
    bool has_fill_width_percent = false;
    float fill_width_percent = 0.0f;
    bool has_fill_height_percent = false;
    float fill_height_percent = 0.0f;
    float resolved_fill_width = 0.0f;
    float resolved_fill_height = 0.0f;
    bool has_resolved_fill_width = false;
    bool has_resolved_fill_height = false;
