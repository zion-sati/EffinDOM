...
// Native definitions for browser-host imports exposed by FUI-RS. N3 services
// live in MacosNativeHost.cpp; later-phase facilities report unsupported here.
extern "C" {
...
bool fui_cut_text_range_snapshot(std::uint64_t, std::uint32_t, std::uint32_t) { return false; }
