...
class MacosNativePlatform final : public NativePlatformHost {
public:
    struct Impl;

    explicit MacosNativePlatform(bool visible = true);
    ~MacosNativePlatform() override;

    MacosNativePlatform(const MacosNativePlatform&) = delete;
    MacosNativePlatform& operator=(const MacosNativePlatform&) = delete;
