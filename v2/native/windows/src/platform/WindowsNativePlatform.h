...
class WindowsNativePlatform final : public NativePlatformHost {
public:
    struct Impl;

    explicit WindowsNativePlatform(bool visible = true);
    ~WindowsNativePlatform() override;

    WindowsNativePlatform(const WindowsNativePlatform&) = delete;
    WindowsNativePlatform& operator=(const WindowsNativePlatform&) = delete;
