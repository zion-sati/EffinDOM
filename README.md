...
- **Tiny App Footprint** — The runtime engine is cached once globally. Your
  app payload is just your business logic (hello-world scaffold: under 100 KB over the wire).
  Sub-second
  Time-To-Interactive.
...
(the hello-world scaffold is under 100 KB over the wire; real apps land in the low hundreds). Flutter, Compose, and egui can't do this — they were ported
